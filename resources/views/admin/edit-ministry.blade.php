...
<div class="row">{{ session('min-alert') }}</div>
        ...
        <div class="ministry ht-100 flow-y-auto wt-100">
            ...
            <form method="POST" action="/update-ministry" class="form-box bg-ddd pad-15 ht-100 flow-y-auto">
                @csrf
                <h3>New Ministry</h3><br>
                <input type="text" placeholder="Enter Ministry" name="m_name" class="new_ministry wt-100" value="{{ session('ministry') }}"><br><br>
                ...
                <input type="hidden" name="id" value="{{ session('min_id') }}">
                <div class="align-right">
                    <a href="/ministry" class="btn bold">&times; Cancel</a>
